...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arcade-ChinaGate_MiSTer.git"
CORE_NAME=(ChinaGate)
...
UPSTREAM_CORE_NAME=(ChinaGate)
MAIN_BRANCH="main"
UPSTREAM_BRANCH="main"
COMPILATION_INPUT=(ChinaGate.qpf)
COMPILATION_OUTPUT=(output_files/ChinaGate.rbf)
